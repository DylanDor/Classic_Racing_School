...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference("Option.count") do
      post options_url, params: { option: { description: @option.description, price: @option.price, quantity: @option.quantity, title: @option.title } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { description: @option.description, price: @option.price, quantity: @option.quantity, title: @option.title } }
